...
/*
        ...
        */
        ...
        pointAB_BC.position = QuadraticLerp(pointA.position, pointB.position, pointC.position, interpolateAmount);
        pointBC_CD.position = QuadraticLerp(pointB.position, pointC.position, pointD.position, interpolateAmount);
    }
